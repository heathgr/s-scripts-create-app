...
var getTemplateSources = function (filePaths) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, Promise.all(filePaths.map(function (file) { return fs_extra_1.readFile(file, 'utf8'); }))];
}); }); };
...
var createProjectDirectories = function (targetFilePaths) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Promise.all(targetFilePaths.map(function (file) { return fs_extra_1.ensureFile(file); }))];
    });
}); };
var writeProjectFiles = function (targetContents, targetFilePaths) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, Promise.all(targetContents.map(function (contents, i) { return fs_extra_1.writeFile(targetFilePaths[i], contents, 'utf8'); }))];
    });
}); };
var createProjectFiles = function (projectFolder, configuration) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                renderedTemplates = getRenderedTemplates(templateSources, configuration);
